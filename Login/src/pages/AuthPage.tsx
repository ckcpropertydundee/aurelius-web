...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-[#F7F6F3]">
      {/* Wordmark */}
      <a
        href="https://aureliuspropertymanagement.co.uk"
        className="flex flex-col items-center justify-center flex-shrink-0 pt-16 pb-10 no-underline"
      >
        <span
          ...
          {mode === 'reset' && resetSent ? (
            ...
            <>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-[50px] bg-[#0D1B3E] text-white rounded-xl text-[14px] tracking-wide font-normal flex items-center justify-center disabled:opacity-60 active:opacity-80 transition-opacity cursor-pointer"
              >
                {isLoading ? (
